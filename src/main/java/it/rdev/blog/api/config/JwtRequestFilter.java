...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		 ...
		 * di inserire Bearer nell'header si può rimuovere il valore dal file di 
		 * configurazione
		 */
		if (requestTokenHeader != null && requestTokenHeader.startsWith(jwtTokenType)) {
			...
			logger.warn("Il token recuperato dall'header Authorization"
					+ " non inizia con la parola chiave Bearer!");
		}
